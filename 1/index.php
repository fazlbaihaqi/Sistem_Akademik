            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>Politeknik Negeri Medan</b></center></h1>
					<center><img src="../aset/foto/ids.png" width="225" height="225" /></center>
					<center><h2><b>Sistem Akademik Copyright &copy;  <?php echo date ('Y') ?></b><br>by Fazl Baihaqi Ashar</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
